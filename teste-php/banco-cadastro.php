...
function inserirUsuarios($con, $nomeCompleto, $email, $nomeUsuario, $departamento, $equipamento) {
    $query = "insert into usuario (nomeCompleto, email, nomeUsuario, codDepartamento, codEquipamento)";
    $query .= "values($nomeCompleto, $email, $nomeUsuario, $departamento, $equipamento)";
    print $query;
    die;
